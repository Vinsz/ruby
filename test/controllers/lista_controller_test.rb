...
class ListaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create listum" do
    assert_difference('Listum.count') do
      post lista_url, params: { listum: { privado: @listum.privado, user_id: @listum.user_id } }
    end
  ...
  test "should update listum" do
    patch listum_url(@listum), params: { listum: { privado: @listum.privado, user_id: @listum.user_id } }
